...
func (b *Blockchain) GetEvent(ctx context.Context, params Transaction, to string) (MintResult, error) {
	result, err := shared.ERC721WaitForTransferEvent(
		ctx,
		b.client,
		common.HexToAddress(params.Contract),
		[]common.Address{shared.ZeroAddress},
		[]common.Address{common.HexToAddress(to)},
		[]*big.Int{},
	)
	if err != nil {
